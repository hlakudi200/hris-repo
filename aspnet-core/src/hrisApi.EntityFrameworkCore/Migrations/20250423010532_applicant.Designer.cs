...
namespace hrisApi.Migrations
{
    ...
    [Migration("20250423010532_applicant")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("hrisApi.Domains.Attendance_Management.AbsenceReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("hrisApi.Domains.Attendance_Management.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("hrisApi.Domains.Employee_Management.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("hrisApi.Domains.Employee_Management.EmployeeDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("hrisApi.Domains.Payroll_Processing.BonusOrCommission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("BonusOrCommissions");
                });

            modelBuilder.Entity("hrisApi.Domains.Payroll_Processing.PayrollProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("hrisApi.Domains.Recruitment_Module.Applicant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("hrisApi.Domains.Recruitment_Module.Interview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("hrisApi.Domains.Recruitment_Module.JobPosting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("hrisApi.Domains.Recruitment_Module.OfferLetter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("hrisApi.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("hrisApi.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("hrisApi.Domains.Employee_Management.Employee", b =>
                {
                    b.HasOne("hrisApi.Domains.Attendance_Management.Project", null)
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("hrisApi.Domains.Payroll_Processing.BonusOrCommission", b =>
                {
                    b.HasOne("hrisApi.Domains.Payroll_Processing.PayrollTransaction", null)
                        .WithMany("BonusesAndCommissions")
            ...
            modelBuilder.Entity("hrisApi.Domains.Recruitment_Module.Interview", b =>
                {
                    b.HasOne("hrisApi.Domains.Recruitment_Module.JobApplication", null)
                        .WithMany("Interviews")
            ...
            modelBuilder.Entity("hrisApi.Domains.Recruitment_Module.JobApplication", b =>
                {
                    b.HasOne("hrisApi.Domains.Recruitment_Module.Applicant", "Applicant")
                        .WithMany()
            ...
            modelBuilder.Entity("hrisApi.Domains.Payroll_Processing.PayrollTransaction", b =>
                {
                    b.Navigation("BonusesAndCommissions");
