...
using hrisApi.Models.TokenAuth;
...
public abstract class hrisApiWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static hrisApiWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(hrisApiWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<hrisApiDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<hrisApiDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<hrisApiDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<hrisApiDbContext, Task<T>> func)
    {
        T result;
